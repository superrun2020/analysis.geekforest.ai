          ...
          {module === "funnel" && page === "workbench" && (
            <div className="page-stack">
              ...
              <section className="surface full-diagnosis-board" id="diagnosis-overview">
                ...
                <div className="active-diagnostic-slice"><span>当前切片</span><strong>{diagnosticSlice}</strong><small>所有指标、原因和证据统一使用该筛选</small>{diagnosticDomain==='ads'&&<div className="funnel-unit-toolbar"><Segmented label="广告变现统计口径" active={unitMode} onChange={(key)=>selectUnitMode(key as UnitMode)} items={[{key:'users',label:'用户 UV'},{key:'events',label:'事件次数'}]} /></div>}</div>
