...
const diagnosticReportMenus: Array<{ key: VpnReportSectionKey; label: string; hint: string }> = [
  ...
  { key: "serverVpnHourly", label: "服务器V小时overall", hint: "按小时 × 节点查询连接质量" },
...
const moduleCopy: Record<ModuleKey, { title: string; description: string; action: string }> = {
  ...
  vpnReport: { title: "诊断报表", description: "包含 VPN Overall、服务器VPN Overall、服务器V小时overall、出口IP质量、广告漏斗Overall、广告DNS诊断、VPN版本对比和Launcher Overall；支持查看内部节点与关联Session证据", action: "导出诊断报表" },
