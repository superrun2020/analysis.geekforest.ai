...
class FunnelAnalyticsQueryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ipKey' => ['nullable', 'regex:/^[a-f0-9]{64}$/'],
            'ipTarget' => 'nullable|string|max:191',
            'ipGranularity' => ['nullable', Rule::in(['exact', 'small', 'large'])],
            'ipQualityStatus' => ['nullable', Rule::in(['suspect', 'watch', 'healthy', 'insufficient'])],
            'minSessionCount' => 'nullable|integer|min:0|max:10000000',
            'minFailedSessionCount' => 'nullable|integer|min:0|max:10000000',
            'minTcpAttemptCount' => 'nullable|integer|min:0|max:10000000',
