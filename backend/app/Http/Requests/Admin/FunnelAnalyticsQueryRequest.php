...
class FunnelAnalyticsQueryRequest extends FormRequest
{
    ...
    {
        return [
            'page' => ['required', Rule::in(['overview', 'workbench', 'diagnosis', 'cohort', 'path', 'evidence', 'issues', 'snapshot', 'network_failure_matrix'])],
            ...
            'dimension' => ['nullable', Rule::in(['app_version', 'country_code', 'network_type', 'device_model', 'ad_format', 'placement'])],
